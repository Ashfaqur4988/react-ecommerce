...
//state for category filter opening and closing
...
export function AdminProductList() {
  ...
  const [page, setPage] = useState(1); //default page should be 1
                  ...
                  <div className="lg:col-span-3">
                    <div>
                      <Link
                        ...
                        className="rounded-md mx-9 my-5 bg-green-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                      >
                        Add New Product
                      </Link>
                    </div>
    ...
    <>
      ...
      <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
        <div>
          <p className="text-sm text-gray-700">
            ...
            <span className="font-medium">
              {(page - 1) * ITEMS_PER_PAGE + 1 /*from this page */}
            </span>{" "}
            to{" "}
            <span className="font-medium">
        ...
        <div>
          ...
          >
            <div
              onClick={(e) => handlePage(page > 1 ? page - 1 : page)} //logic for the previous button
            ...
            <div
              onClick={(e) => handlePage(page < totalPage ? page + 1 : page)} //logic to implement the next page switch
